...
- `combined release-shadow`: source-level candidate booted from a workspace-local shadow of `/opt/simplehostman/release`, still below deploy/release promotion
