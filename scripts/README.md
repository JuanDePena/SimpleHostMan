...
They now package and deploy the combined `apps/control` runtime as the operational default together with `simplehost-worker` and `simplehost-agent`.
...
- `combined current`: operational runtime shape used by deploy scripts and current packaging
