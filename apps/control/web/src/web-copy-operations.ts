...
export const operationsCopyByLocale = {
  en: {
    ...
    bootstrapInventoryDescription:
      "Use YAML import only as a transitional bootstrap or disaster-recovery source. The PostgreSQL resource catalog remains authoritative.",
  ...
  es: {
    ...
    bootstrapInventoryDescription:
      "Usa la importación YAML solo como mecanismo transicional de bootstrap o disaster recovery. El catálogo de recursos en PostgreSQL sigue siendo autoritativo.",
