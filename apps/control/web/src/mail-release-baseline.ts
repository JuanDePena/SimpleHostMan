  ...
  return {
    ...
    iam: {
      ...
      operationalState: {
        ...
        nativeControlProviderSlug: "pyrosa-iam",
        nativeControlAuthMode: "oauth_login",
        nativeControlPromotionState: "selected_native_login_policy",
        nativeControlPromotionPolicy: "native_oauth_login_under_authentik_outer_gate",
        nativeControlOuterGateProviderSlug: "authentik",
        nativeControlRollbackProviderSlug: "authentik",
