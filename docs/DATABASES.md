...
- [`/opt/simplehostman/repos/simplehost-manager/platform/postgresql/apps/conf/postgresql.apps.primary.conf`](/opt/simplehostman/repos/simplehost-manager/platform/postgresql/apps/conf/postgresql.apps.primary.conf)
- [`/opt/simplehostman/repos/simplehost-manager/platform/postgresql/apps/conf/postgresql.apps.standby.conf`](/opt/simplehostman/repos/simplehost-manager/platform/postgresql/apps/conf/postgresql.apps.standby.conf)
- [`/opt/simplehostman/repos/simplehost-manager/platform/postgresql/apps/conf/pg_hba.apps.conf`](/opt/simplehostman/repos/simplehost-manager/platform/postgresql/apps/conf/pg_hba.apps.conf)
- [`/opt/simplehostman/repos/simplehost-manager/scripts/bootstrap-apps-standby.sh`](/opt/simplehostman/repos/simplehost-manager/scripts/bootstrap-apps-standby.sh)
...
- [`/opt/simplehostman/repos/simplehost-manager/platform/mariadb/conf/primary.cnf`](/opt/simplehostman/repos/simplehost-manager/platform/mariadb/conf/primary.cnf)
- [`/opt/simplehostman/repos/simplehost-manager/platform/mariadb/conf/replica.cnf`](/opt/simplehostman/repos/simplehost-manager/platform/mariadb/conf/replica.cnf)
...
- [`/opt/simplehostman/repos/simplehost-manager/platform/mariadb/sql/configure-replica.sql.template`](/opt/simplehostman/repos/simplehost-manager/platform/mariadb/sql/configure-replica.sql.template)
- [`/opt/simplehostman/repos/simplehost-panel/packaging/postgresql/shp/conf/postgresql.shp.primary.conf`](/opt/simplehostman/repos/simplehost-panel/packaging/postgresql/shp/conf/postgresql.shp.primary.conf)
- [`/opt/simplehostman/repos/simplehost-panel/packaging/postgresql/shp/conf/postgresql.shp.standby.conf`](/opt/simplehostman/repos/simplehost-panel/packaging/postgresql/shp/conf/postgresql.shp.standby.conf)
- [`/opt/simplehostman/repos/simplehost-panel/packaging/postgresql/shp/conf/pg_hba.shp.conf`](/opt/simplehostman/repos/simplehost-panel/packaging/postgresql/shp/conf/pg_hba.shp.conf)
- [`/opt/simplehostman/repos/simplehost-panel/scripts/bootstrap-shp-standby.sh`](/opt/simplehostman/repos/simplehost-panel/scripts/bootstrap-shp-standby.sh)
- [`/opt/simplehostman/repos/simplehost-panel/packaging/postgresql/shp/sql/create-shp-database.sql.template`](/opt/simplehostman/repos/simplehost-panel/packaging/postgresql/shp/sql/create-shp-database.sql.template)
...
4. Install these rendered artifacts into the cluster data directory:
   - [`/opt/simplehostman/repos/simplehost-panel/packaging/postgresql/shp/conf/postgresql.shp.primary.conf`](/opt/simplehostman/repos/simplehost-panel/packaging/postgresql/shp/conf/postgresql.shp.primary.conf) as `postgresql.conf`
   - [`/opt/simplehostman/repos/simplehost-panel/packaging/postgresql/shp/conf/pg_hba.shp.conf`](/opt/simplehostman/repos/simplehost-panel/packaging/postgresql/shp/conf/pg_hba.shp.conf) as `pg_hba.conf`
...
7. Create the `SHP` database and role from [`/opt/simplehostman/repos/simplehost-panel/packaging/postgresql/shp/sql/create-shp-database.sql.template`](/opt/simplehostman/repos/simplehost-panel/packaging/postgresql/shp/sql/create-shp-database.sql.template).
...
2. Create the host-native cluster unit:
   - `postgresql-new-systemd-unit --unit postgresql@shp --datadir /var/lib/pgsql/shp/data`
3. Bootstrap the standby data directory from the primary with [`/opt/simplehostman/repos/simplehost-panel/scripts/bootstrap-shp-standby.sh`](/opt/simplehostman/repos/simplehost-panel/scripts/bootstrap-shp-standby.sh).
4. Install these rendered artifacts into the cluster data directory:
   - [`/opt/simplehostman/repos/simplehost-panel/packaging/postgresql/shp/conf/postgresql.shp.standby.conf`](/opt/simplehostman/repos/simplehost-panel/packaging/postgresql/shp/conf/postgresql.shp.standby.conf) as `postgresql.conf`
   - [`/opt/simplehostman/repos/simplehost-panel/packaging/postgresql/shp/conf/pg_hba.shp.conf`](/opt/simplehostman/repos/simplehost-panel/packaging/postgresql/shp/conf/pg_hba.shp.conf) as `pg_hba.conf`
5. Ensure `5433/tcp` is labeled for PostgreSQL under SELinux:
   - `semanage port -a -t postgresql_port_t -p tcp 5433`
